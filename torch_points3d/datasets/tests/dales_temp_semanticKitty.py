...
# CLEAN UP UPPER PART AS IT CHANGED

# NEW LINKS
# https://github.com/nicolas-chaulet/torch-points3d/issues/471
# Reference data from pytorch 3dpoints = semantickitty
# Usefull youtube link : https://www.youtube.com/watch?v=QLIkOtKS4os (using https://github.com/deepfindr/gnn-project/blob/main/dataset.py and
# https://github.com/deepfindr/gnn-project/blob/main/dataset_featurizer.py

################################### IMPORTS #######################################
# From semantickitty.py (torch_points3d) (to merge with upper part)
...
class SemanticKitti(Dataset):
    ...
    def __init__(self, root, split="trainval", transform=None, process_workers=1, pre_transform=None):
        ...
        #Debug LR (temp)
        print(self.processed_paths[0]) #Temp
        print(self.processed_paths[1]) #Temp
        print(self.processed_paths[2]) #Temp

        """Define processed_paths and self._scans"""
    ...
    def processed_file_names(self):
        ...
        #Debug LR (temp)
        print(s for s in self.AVAILABLE_SPLITS[:-1])
